...
## Prepare data 
R CMD BATCH --vanilla ../scripts/01_UKB_dataPrep.R ../scripts/01_UKB_dataPrep.R.out
cp Rplots.pdf 01_UKB_dataPrep_Rplots.pdf
mv 01_UKB_dataPrep_Rplots.pdf ../results/
rm Rplots.pdf

# Run PWAS
R CMD BATCH --vanilla ../scripts/02_UKB_PWAS.R ../scripts/02_UKB_PWAS.R.out

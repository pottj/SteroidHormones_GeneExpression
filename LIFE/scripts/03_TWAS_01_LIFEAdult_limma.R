...
save(Adult, file = "../results/03_TWAS_01_SummaryStatistics_LIFEAdult.RData")
...
save(myTab, file = "../results/03_TWAS_01_SummaryStatistics_LIFEAdult_hierFDR.RData")

#' # Save per trait ####
#' ***
#' I plan to upload the TWAS summary statistics per trait. Hence, I want a text file per hormone - setting - model
#' 
outdir = "../results/03_TWAS_01_Adult_SummaryStatistics/"

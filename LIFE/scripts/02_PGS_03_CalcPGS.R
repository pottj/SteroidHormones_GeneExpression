...
if(file.exists("../results/02_PGS_03_range_list")){
  # I might end up rerunning this with different thresholds
  myCall = paste0("rm ../results/02_PGS_03_range_list")
  system(myCall)
}
for(i in 1:length(dummy)){
  myCall = paste0("echo '",dummy[i],' 0 ',dummy[i],"' >> ../results/02_PGS_03_range_list")
  system(myCall)
}
...
for(i in 1:length(files)){
  ...
  myCall1 = paste0(path_plink1.9,
                   ...
                   " --clump-snp-field ID",
                   " --clump-field P",
                   " --out ../results/02_PGS_03_PLINK_PGS/Adult_Clumping_",hormone,"_",setting)
  myCall1
  system(myCall1)
  
  # Step 2: extract SNPs out of result file (these are the clumped independent SNPs)
  myCall2 = paste0("awk 'NR!=1{print $3}' ../results/02_PGS_03_PLINK_PGS/Adult_Clumping_",hormone,"_",setting,".clumped >  ../results/02_PGS_03_PLINK_PGS/Adult_Clumping_",hormone,"_",setting,".valid.snp")
  system(myCall2)
  ...
  myCall3a = paste0(path_plink2,
                   ...
                   " --extract ../results/02_PGS_03_PLINK_PGS/Adult_Clumping_",hormone,"_",setting,".valid.snp",
                   ...
                   " --out ../results/02_PGS_03_PLINK_PGS/Adult_Score_",hormone,"_",setting)
  myCall3a
  system(myCall3a)
  ...
  myCall3b = paste0(path_plink2,
                    ...
                    " --score ",path_SumStats_QC,files[i]," 14 4 8 header",
                    " --q-score-range ../results/02_PGS_03_range_list ",path_SumStats_QC,hormone,"_",setting,".pvalue",
                    " --out ../results/02_PGS_03_PLINK_PGS/Heart_Score_",hormone,"_",setting)
  myCall3b
  system(myCall3b)

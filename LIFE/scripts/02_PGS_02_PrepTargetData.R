...
myCall1 = paste0(path_plink2,
                 ...
                 " --extract ../results/02_PGS_01_SNPList_raw.txt",
                 " --maf 0.01",
                 " --hwe 1e-6",
                 " --geno 0.01",
                 " --mind 0.01", 
                 ...
                 " --write-snplist", 
                 " --make-just-fam", 
                 " --out ../results/02_PGS_02_PLINK_prep/Adult_QC_SNPList")
myCall1
system(myCall1)
...
myCall2 = paste0(path_plink2,
                 " --pfile ",path_LIFEAdult_Genetics,
                 " --extract ../results/02_PGS_02_PLINK_prep/Adult_QC_SNPList.snplist",
                 " --keep ../results/02_PGS_02_PLINK_prep/Adult_QC_SNPList.fam", 
                 " --indep-pairwise 200 50 0.25", 
                 " --out ../results/02_PGS_02_PLINK_prep/Adult_QC_Pruning")
myCall2
system(myCall2)
...
myCall3 = paste0(path_plink2,
                 " --pfile ",path_LIFEAdult_Genetics,
                 " --extract ../results/02_PGS_02_PLINK_prep/Adult_QC_Pruning.prune.in",
                 " --make-bed",
...
#                  " --write-snplist", 
#                  " --make-just-fam", 
#                  " --out ../results/02_PGS_02_PLINK_prep/Heart_QC_SNPList")
# myCall4
# system(myCall4)
...
#                  " --pfile ",path_LIFEHeart_Genetics,
#                  " --extract ../results/02_PGS_02_PLINK_prep/Heart_QC_SNPList.snplist",
#                  " --keep ../results/02_PGS_02_PLINK_prep/Heart_QC_SNPList.fam", 
#                  " --indep-pairwise 200 50 0.25", 
#                  " --out ../results/02_PGS_02_PLINK_prep/Heart_QC_Pruning")
# myCall5
# system(myCall5)
...
myCall6 = paste0(path_plink2,
                 " --pfile ",path_LIFEHeart_Genetics,
                 # " --extract ../results/02_PGS_02_PLINK_prep/Heart_QC_Pruning.prune.in",
                 " --extract ../results/02_PGS_02_PLINK_prep/Adult_QC_Pruning.prune.in",
                 " --make-bed",

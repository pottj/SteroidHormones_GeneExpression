...
write.table(all_genes_b38, "../results/01_prep_03_biomart_genes_GRCh38.txt",row.names = F)
...
#' # Save ####
#' ***
save(PathwayGenes, file="../results/01_prep_03_PathwayGenes_byGene.RData")
...
save(PathwayGenes_filt, file="../results/01_prep_03_PathwayGenes_byCytoband.RData")

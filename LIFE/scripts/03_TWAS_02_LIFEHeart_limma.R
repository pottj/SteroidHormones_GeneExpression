...
save(Heart, file = "../results/03_TWAS_02_SummaryStatistics_LIFEHeart.RData")
...
save(myTab, file = "../results/03_TWAS_02_SummaryStatistics_LIFEHeart_hierFDR.RData")

#' # Save per trait ####
#' ***
#' I plan to upload the TWAS summary statistics per trait. Hence, I want a text file per hormone - setting - model
#' 
outdir = "../results/03_TWAS_02_Heart_SummaryStatistics/"

...
#' # Load data ####
#' ***
load("../results/01_TWAS_SummaryStatistics_LIFEAdult_hierFDR.RData")
Adult = copy(myTab)
...
# save the plot
ggsave(paste0("../results/04_Plots/Barplot_noBMIadj.png"), height = 7, width = 7)
...
# save the plot
ggsave(paste0("../results/04_Plots/Barplot_BMIadj.png"), height = 7, width = 7)
...
ggsave(paste0("../results/04_Plots/VolcanoPlot_CORT.png"), height = 7, width = 14)
...
ggsave(paste0("../results/04_Plots/VolcanoPlot_TESTO.png"), height = 14, width = 14)
...
ggsave(paste0("../results/04_Plots/VolcanoPlot_E2.png"), height = 14, width = 14)
...
for(i in 1:length(myTraits)){
  ...
  ggplot(data=Adult[trait == myTraits[i],], 
    ...
    ylab(expression("-log10(adjusted p-value)"))+ 
    theme(legend.position = "none")
  ggsave(paste0("../results/04_Plots/VolcanoPlot_",myTraits[i],".png"), height = 7, width = 7)

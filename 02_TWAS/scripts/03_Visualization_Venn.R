...
load("../results/02_TWAS_SummaryStatistics_LIFEHeart_hierFDR.RData")
Heart = copy(myTab)
...
save(ProbeList1, file = "../results/03_ProbeList1_Replicated_in_Heart.RData")
save(ProbeList2, file = "../results/03_ProbeList2_Replicated_in_BMImodels.RData")
save(ProbeList3, file = "../results/03_ProbeList3_Adult_noBMIadj.RData")
save(ProbeList4, file = "../results/03_ProbeList4_Adult_BMIadj.RData")
save(ProbeList5, file = "../results/03_ProbeList5_Adult_any.RData")

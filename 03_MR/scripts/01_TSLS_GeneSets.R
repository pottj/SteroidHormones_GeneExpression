...
#' Candidate genes
load("../../02_TWAS/results/03_ProbeList5_Adult_any.RData")
...
#' ## Gene set 4 ####
load("../../02_TWAS/results/03_ProbeList4_Adult_BMIadj.RData")
...
#' ## Gene set 3 ####
load("../../02_TWAS/results/03_ProbeList3_Adult_noBMIadj.RData")
...
#' ## Gene set 2 ####
load("../../02_TWAS/results/03_ProbeList2_Replicated_in_BMImodels.RData")
...
#' ## Gene set 2 ####
load("../../02_TWAS/results/03_ProbeList1_Replicated_in_Heart.RData")
...
save(TSLS_Tab,file = "../results/01_TSLS_Adult.RData")

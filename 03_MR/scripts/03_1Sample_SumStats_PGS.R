...
save(Adult, file = "../temp/03_TWAS_SummaryStatistics_PGS.RData")

#' # Linear regression of PGS on hormones ####
#' ***
load("../../01_PGS/results/10_PGSresults_selectionScaled.RData")
...
#' # Save results ####
#' ***
save(Adult,file = "../results/03_1sample_SummaryStatistics_transcriptomeWide.RData")
save(Adult2,file = "../results/03_1sample_SummaryStatistics_geneSet2.RData")
